...
export default function ProductSuite() {
  ...
  const AgentCard = ({ icon: Icon, title, description }) => (
  ...
  const BusinessAgentCard = ({ icon: Icon, title, description }) => (
      ...
      <main className="flex-grow">
        ...
        <section className="py-12 bg-[#6B705C]">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-8">
              <Link href="/business-agents" className="inline-block bg-[#FFCB1F] text-[#370300] hover:bg-[#FFCB1F]/90 px-6 py-3 rounded font-bold">
