...
const Trait: React.FC<TraitProps> = ({ icon: Icon, title, description }) => (
...
const RoleSupport: React.FC<RoleSupportProps> = ({ icon: Icon, role, description, bgColor, iconColor, headingColor }) => (
...
const Interaction: React.FC<InteractionProps> = ({ question, answer }) => (
